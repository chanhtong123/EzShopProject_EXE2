    ...
    public class ShopController {
        ...
        @GetMapping("/guest/shop/byProduct/{productId}")
        public ResponseEntity<ShopResponse> getShopByProductId(@PathVariable Long productId) {
            Optional<Shop> optionalShop = iShopService.getShopByProductId(productId);
            return optionalShop.map(shop -> ResponseEntity.ok(mapToShopResponse(shop)))
